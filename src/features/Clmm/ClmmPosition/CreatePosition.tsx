...
import { ApiV3PoolInfoConcentratedItem, ApiV3Token, PoolFetchType, solToWSol } from '@rbx/rbx-sdk'
                ...
                <Flex gap={'clamp(32px, 2.7vw, 70px)'} justifyContent={'space-between'} whiteSpace={'nowrap'}>
                  ...
                  <Flex gap="2" alignItems="center">
                    ...
                    <Text color={colors.textSecondary}>
                      {formatCurrency(currentPool?.day.volumeFee, { symbol: '$', decimalPlaces: 2 })}
                    </Text>
                  </Flex>
                </Flex>
              </Desktop>
